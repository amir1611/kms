...
@section('main-content')
    <div class="container2" style="background-color: white; border-radius: 30px; margin-left: 100px; margin-right: 100px;">
        ...
        <!-- Route to user.update based on the user id to update the user complaint-->
        <form action="{{ route('user.updateComplaint', ['id' => $application->application_id]) }}" method="POST">
            ...
            <div class="row mt-4 profile-header">
                <h4 class="font-weight-bold mx-auto mt-2 profile-title">Edit Kiosk Complaint</h4>
            </div>

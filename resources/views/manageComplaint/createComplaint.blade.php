...
@section('main-content')
    <div class="container2" style="background-color: white; border-radius: 30px; margin-left: 100px; margin-right: 100px;">
        ...
        <form action="{{ route('user.submitCreateComplaint') }}" method="POST" enctype="multipart/form-data">
            <div class="mt-4 profile-header pr-5 pl-5 pt-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="w-100">
                        <input type="date" class="form-control" id="business_create_complaint" name="business_create_complaint"
                            required>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="w-100">
                        <textarea name="complaint_information" class="form-control" id="complaint_information" cols="30" rows="5"
                            placeholder="Describe the complaints"></textarea>
                    </div>
                </div>
